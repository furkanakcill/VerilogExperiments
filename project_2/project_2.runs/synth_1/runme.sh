...
HD_PWD='C:/SSTU Dosyalar/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sequence_detector.tcl
