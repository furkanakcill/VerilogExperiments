...
HD_PWD='C:/SSTU Dosyalar/project_experiment_6/project_experiment_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM1.tcl -notrace
