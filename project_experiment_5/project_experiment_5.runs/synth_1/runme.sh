...
HD_PWD='C:/SSTU Dosyalar/project_experiment_5/project_experiment_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_latch_nand.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sr_latch_nand.tcl
