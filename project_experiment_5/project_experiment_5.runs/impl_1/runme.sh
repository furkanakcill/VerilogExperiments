...
HD_PWD='C:/SSTU Dosyalar/project_experiment_5/project_experiment_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_latch_nand.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sr_latch_nand.tcl -notrace
