...
HD_PWD='C:/SSTU Dosyalar/project_experiment_7/project_experiment_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MULTS.tcl -notrace
