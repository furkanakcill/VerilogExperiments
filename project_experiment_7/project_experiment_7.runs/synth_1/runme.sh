...
HD_PWD='C:/SSTU Dosyalar/project_experiment_7/project_experiment_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULTS.tcl
